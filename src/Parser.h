...
namespace bms_parser
{
	...
	private:
		...
		void ParseHeader(Chart *Chart, std::string_view cmd, std::string_view Xx, const std::string &Value);
		inline bool MatchHeader(const std::string_view &str, const std::string_view &headerUpper);
